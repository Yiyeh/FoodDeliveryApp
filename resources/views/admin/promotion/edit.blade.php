...
<div class="container">
	...
	<div class="col-sm-11">
		<a href="{{route('admin.promotion.index')}}" class="btn  btn-info pull-right">Show List</a> <br><br><br>

		@include('layouts._errors')
	
		{!! Form::model($promotion, ['route' => ['admin.promotion.update', $promotion->id],'method' => 'PUT']) !!}
